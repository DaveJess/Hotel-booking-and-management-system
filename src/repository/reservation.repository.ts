...
export default class ReservationRepository {
	...
	async updateReservation(id: string, update: Partial<IReservation>): Promise<IReservation | null> {
	...
	async getAllReservations(filter: mongoose.FilterQuery<IReservation> = {}): Promise<IReservation[]> {
